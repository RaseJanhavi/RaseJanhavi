...
☁️ Focused on Cloud Infrastructure, CI/CD Automation & Containerization
🏅 Microsoft Certified: Azure Fundamentals (AZ-900)
🌱 Currently deepening skills in Terraform, Kubernetes, and AWS architecture
📍 Solapur, Maharashtra | Open to On-site · Hybrid · Remote

Tech Stack
CI/CD & Automation
Jenkins · Maven · Bash/Shell Scripting
...
- Implemented least-privilege IAM role-based access control (UploadOnly, ReadOnly, Admin) for S3 and EC2 resources, attached via instance profiles
- Configured encrypted, versioned S3 buckets with lifecycle policies and bucket-level access controls
- Set up CloudWatch alarms (CPU, disk space, failed logins) with SNS notifications for real-time infrastructure alerting
...
DevOps & Multi-Cloud Project Experience | PaperLive Learning | 2026
